    ...
    <div className="p-3 bg-zinc-950 border border-zinc-800 rounded-sm font-mono text-xs space-y-2.5">
      <div className="flex flex-col gap-1.5 text-[11px]">
        ...
        <div className="flex items-center gap-3 text-zinc-400">
          <span>
            TIME: <strong className="text-lime-400">{formattedTime}s</strong>
          </span>
        </div>
      </div>
      ...
      <div className="space-y-1">
        <div className="flex justify-between items-center text-[10px] font-bold">
          ...
          <span className="text-lime-400">{formattedPercent}%</span>
        </div>
        ...
        <div className="h-2 w-full bg-zinc-900 border border-zinc-800/80 rounded-xs overflow-hidden p-[1px]">
          {/* animated fill */}
          <div
            className="h-full bg-lime-500 transition-all duration-150 ease-out rounded-xs relative"
            style={{ width: `${clampedPercent}%` }}
          >
            {/* glow effect */}
            <div className="absolute right-0 top-0 bottom-0 w-1 bg-lime-300 shadow-[0_0_8px_rgba(245,158,11,0.8)]" />
          </div>
        </div>
      </div>
